/*
 * recentItemsSubmenu.js - Manages the recent items submenu in the Apple menu.
 * Adapted from Kiwi Menu's RecentItemsSubmenu for MacTop.
 */
...
export const RecentItemsSubmenu = GObject.registerClass(
  ...
  _startGlobalHoverMonitor() {
    ...
    GLib.Source.set_name_by_id(this._globalHoverMonitorId, 'MacTopGlobalHoverMonitor');
  }
  ...
  _scheduleClose() {
    ...
    GLib.Source.set_name_by_id(this._hoverCloseTimeoutId, 'MacTopHoverCloseDelay');
  }
  ...
  _scheduleOpen() {
    ...
    GLib.Source.set_name_by_id(this._openDelayTimeoutId, 'MacTopRecentOpenDelay');
  }
  ...
  async _ensureRecentMenu() {
    ...
    this._recentMenu.actor.add_style_class_name('mactop-recent-menu');
  ...
  _notifyLaunchFailure(title, message) {
    try {
      ...
      logError(error, 'Failed to display MacTop notification');
    }
  }
